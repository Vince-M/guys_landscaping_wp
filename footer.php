      ...
      <div class="social__wrapper">
        ...
        <div class="social social__column">
          <div class="social social__column--left">
            <a href="https://www.facebook.com/guyslandscapingca" target="_blank"><img src="<?php echo get_theme_file_uri('/dist/img/facebook-icon.svg') ?>" width="56px" height="56px" alt="Visit Guy's Landscaping on Facebook"></a>
            <p>Follow on <a class="facebook" href="#"><strong>Facebook</strong></a> for more great photos</p>
          </div>
          <div class="social social__column--right">
           <a href="mailto: info@guyslandscaping.ca"><img src="<?php echo get_theme_file_uri('/dist/img/contact-env.svg') ?>" width="66px" height="38px" alt="contact Guy's Landscaping"></a>
